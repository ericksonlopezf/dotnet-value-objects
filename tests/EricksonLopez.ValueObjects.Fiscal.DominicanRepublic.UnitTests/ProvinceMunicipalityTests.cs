...
public sealed class ProvinceMunicipalityTests
{
    ...
    public void Properties_And_Parsing_WorkCorrectly()
    {
        ...
        var reconstituted = ProvinceMunicipality.Reconstitute("01001");
        reconstituted.Value.Should().Be("01001");

        var hydrated = ProvinceMunicipality.Hydrate("01001");
        hydrated.Value.Should().Be("01001");
    }
}
