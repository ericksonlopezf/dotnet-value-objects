...
public sealed class HierarchyPathTests
{
    ...
    public void Root_And_Sanitize_WorkCorrectly()
    {
        ...
        HierarchyPath.Create("/seg with space/").Error.Code.Should().Be("HierarchyPath.InvalidSegment");
        HierarchyPath.Create("/seg\\backslash/").Error.Code.Should().Be("HierarchyPath.InvalidSegment");
        HierarchyPath.Create("/seg\ttab/").Error.Code.Should().Be("HierarchyPath.InvalidSegment");
        HierarchyPath.Create("/../").Error.Code.Should().Be("HierarchyPath.InvalidSegment");
        HierarchyPath.Create("/./").Error.Code.Should().Be("HierarchyPath.InvalidSegment");

        parent.TryAppend("///").Error.Code.Should().Be("HierarchyPath.InvalidSegment");
        parent.TryAppend("seg with space").Error.Code.Should().Be("HierarchyPath.InvalidSegment");
        parent.TryAppend("seg\\backslash").Error.Code.Should().Be("HierarchyPath.InvalidSegment");
        parent.TryAppend("seg\ttab").Error.Code.Should().Be("HierarchyPath.InvalidSegment");
        parent.TryAppend("..").Error.Code.Should().Be("HierarchyPath.InvalidSegment");
        parent.TryAppend(".").Error.Code.Should().Be("HierarchyPath.InvalidSegment");
    }
}
