...
public sealed class ValueObjectDefaultInitializationAnalyzerTests
{
    ...
    [Fact]
    public async Task Analyze_WhenObjectCreationWithoutArgumentListUsed_ReportsDiagnostic()
    {
        var source = """
        namespace SampleNamespace;
        ...
        public class Consumer
        {
            public void Run()
            {
                var x = new MyStructVo { Amount = 10 };
            }
        }
        """;
    ...
    [Fact]
    public async Task Analyze_WhenObjectCreationHasArguments_DoesNotReportDiagnostic()
    {
        var source = """
        namespace SampleNamespace;
    ...
    [Fact]
    public async Task Analyze_WhenValueObjectAttributeShortNameUsed_ReportsDiagnostic()
    {
        var source = """
        namespace SampleNamespace;
